...
[ -d ".ccpm/prds" ] && echo "  PRDs directory exists" || echo "  PRDs directory missing"
[ -d ".ccpm/epics" ] && echo "  Epics directory exists" || echo "  Epics directory missing"
[ -d ".ccpm/rules" ] && echo "  Rules directory exists" || echo "  Rules directory missing"
echo ""
