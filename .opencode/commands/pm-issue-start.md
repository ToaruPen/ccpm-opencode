---
description: Begin work on a GitHub issue with parallel agents
---
...
Task:
  ...
  prompt: |
    ...
    5. Follow coordination rules in .ccpm/rules/agent-coordination.md
...
Follow @.ccpm/rules/datetime.md for timestamps.
